...
There is some lie factor in this plot as I changed the scale of the bubble size because it was hard to tell them apart initially. The fertility rates of most countries are pretty similar. Data-ink ratio on this plot is medium, since four variables are being show simultaneously but I had to include a rather large legend and annotation to make sure the message was conveyed. Data density is high though, because of these four variables. It could be higher, still, if a fifth feature was added in the form of the shape of a point. 
